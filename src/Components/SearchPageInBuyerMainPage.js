...
//             {Array.from(seller).map((data, index) => (
//                 <SellerProfileSearchBuyer GoSellerProfilePage={GoSellerProfilePage} show={true} Name={data.name} UserName={data.user_name} ></SellerProfileSearchBuyer>
//             ))}
//         </Box>
//     )
// }else{
//     return (
//         <SellersProfile uid={'c368393'}></SellersProfile>
//     )
// }
